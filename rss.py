...
faviconUrl = f'{ imageCdn }https://external-content.duckduckgo.com/ip3/weibo.com.ico'
...
# feed.icon( f'{ imageCdn }https://external-content.duckduckgo.com/ip3/www.taiwanplus.com.ico' )
